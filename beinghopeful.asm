...
addi $sp, $sp, -4	
sw $t5, ($sp)
addi $sp, $sp, -4		         # store all the data structures before jumping in next row
sw $t6, ($sp)
addi $sp, $sp -4
sw $t7, ($sp)	
addi $sp, $sp, -4
...
beq $v0, $t0, return_middle

addi $sp, $sp, -4
sw $ra, ($sp)
jal clean_board_insider			 # if the trial failed we need to delete all the foken lizards to start the next trial fresh
addi $sp, $sp, 4
lw $ra, ($sp)
